...
public class AspectLog  extends JerimumAspectLog {
    ...
    @Before("br.com.scopus.simulador.portal.aop.AspectPointcuts.rest()")
    @Override
    public void logEntry(JoinPoint jp) throws Exception {
        super.logEntry(jp);
    }

    @AfterReturning(pointcut = "(br.com.scopus.simulador.portal.aop.AspectPointcuts.rest()) && (execution(void *..*(..)))")
    @Override
    public void logExit(JoinPoint jp) throws Exception {
        super.logExit(jp);
    }

    @AfterReturning(pointcut = "(br.com.scopus.simulador.portal.aop.AspectPointcuts.rest()) && !(execution(void *..*(..)))", returning = "returningValue", argNames = "jp,returningValue")
    @Override
    public void logExit(JoinPoint jp, Object returningValue) throws Exception {
        super.logExit(jp, returningValue);
    }

    @AfterThrowing(pointcut = "br.com.scopus.simulador.portal.aop.AspectPointcuts.rest()", throwing = "ex", argNames = "jp,ex")
    @Override
