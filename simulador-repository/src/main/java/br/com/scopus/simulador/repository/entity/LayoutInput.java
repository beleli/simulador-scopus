...
/**
 * Classe de entidade persistente para a tabela tb_cte_layout_input.
 * Tabela legada: tCpoRquisSmula
 * 
...
@Entity
@Table(name = "tb_cte_layout_input")
public class LayoutInput extends AbstractEntity<Long> {

    private static final long serialVersionUID = -9052504442943671603L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id_layout_input", unique = true, nullable = false)
    private Long id;
