 ...
 * @since 1.0
 */
public class LayoutOutputTransactionTemplate implements TemplateLoaderEntity {

    @Override
    public void load() {
        Fixture.of(LayoutOutputTransaction.class).addTemplate(NOVO, new Rule() {
            {
                add("id", null);
        ...
        Fixture.of(LayoutOutputTransaction.class).addTemplate(NOVO_COM_ID, new Rule() {
            {
